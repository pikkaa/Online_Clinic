...
?>
	...
	<form method="post" action="changepass.php">
      <table width="600" cellspacing="20px" align="center" style="margin-top:50px;margin-bottom:50px">
        ...
        <tr>
          <td  width="300px" align="right" style="font-family:'Courier New', Courier, monospace;font-size:18px;font-weight:bold;color:#006699">Enter Patient ID : </td>
          <td width="300px"><input type="text" name="id" size="25px" /></td>
        </tr>
        <tr>
