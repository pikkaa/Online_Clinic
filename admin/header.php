...
<th style="height:80px;width:170px;"><a href="staff.php">Doctors & medical staff</a></th>
<th style="height:80px;width:170px;"><a href="test.php" target="_blank">Lab Test</a></th>
</tr></table>
...
<tr><th colspan="2"><form action="admin.php" method="post"><input type="submit" value="Admin Login" style="height:35px;width:85px;background:blue;color:white;font-size:12px;font-weight:bold;border-radius:20px;cursor:pointer" /></form></th></tr>
</table>
