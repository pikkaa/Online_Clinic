...
<tr><th width="100%" align="center" colspan="3" style="color:#FF3399;font-family:'Courier New', Courier, monospace;border-bottom:black solid 1px;"><h1>TIMINGS(
<?php
$a=$_REQUEST['a'];
echo $a;
?> )ALready booked</h1></th></tr>
